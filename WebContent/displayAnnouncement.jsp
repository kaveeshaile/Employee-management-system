	...
	<div>
		...
		style="border: 0.5px white;">
				...
				<tr style="background-color:white ;">
					...
					<td>
						<form method="POST" action="selectAnnouncementServlet">
							<input type="hidden" name="id"
								value="<%=announcement.getId() %>"> <input
								type="submit" value="Select Announcement" class="select-button" />
						</form>
					</td>
				</tr>
				<%
				...
				<tr>
					<td colspan="2">
						<button type="button"
							...
							onclick="window.location='AdminMainInterface.jsp'">home</button>
					</td>
				</tr>
			</table>
			<br>
